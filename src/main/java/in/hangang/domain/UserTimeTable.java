...
public class UserTimeTable {
    ...
    @NotNull(groups = {ValidationGroups.createUserTimeTable.class, ValidationGroups.updateUserTimeTable.class},
            message = "시간표 이름은 비워둘 수 없습니다.")
    @Length(groups = {ValidationGroups.createUserTimeTable.class, ValidationGroups.updateUserTimeTable.class},
            min=1, max =20, message = "시간표 이름은 1글자 이상 20글자 이하입니다.")
    private String name;
    @ApiModelProperty(hidden = true)
